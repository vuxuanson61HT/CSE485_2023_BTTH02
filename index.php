...
<body>
    <header>
        ...
        <div id="carouselExampleIndicators" class="carousel slide">
            ...
            <div class="carousel-inner">
                ...
                <img src="assets/images/slideshow/slide01.jpg" style="width: 100%; height: 250px;" class="" alt="...">
                </div>
                <div class="carousel-item">
                <img src="assets/images/slideshow/slide02.jpg"style="width: 100%; height: 250px;" class="" alt="...">
                </div>
                <div class="carousel-item">
                <img src="assets/images/slideshow/slide03.jpg"style="width: 100%; height: 250px;" class="" alt="...">
                </div>
            </div>
    ...
    <main class="container-fluid mt-3">
        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="card mb-2" style="width: 100%;">
                    <img src="assets/images/songs/vetmua.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title text-center my-title">
